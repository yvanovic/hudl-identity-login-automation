...
class LoginPasswordPage:
    ...
    def __init__(self, page: Page):
        ...
        self.show_hide_password_button = page.get_by_role(
            "button", name="Show password"
        )
        self.error_message = page.get_by_text("Incorrect password. Please try again.")
    ...
    def click_show_hide_password(self) -> None:
        ...
        self.show_hide_password_button.click()

    def assert_incorrect_password(self) -> None:
        """Assert that an error message is shown when an incorrect password is entered."""
